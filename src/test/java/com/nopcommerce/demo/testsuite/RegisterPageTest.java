...
public class RegisterPageTest extends BaseTest {
    ...
    public void VerifyThatUserShouldCreateAccountSuccessfully() {
        ...
        // Select day
        registerPage.dateOfBirthDay("16");
        // Select month
        registerPage.dateOfBirthMonth("October");
        // Select year
        registerPage.birthYear("1993");
        // Enter email
        registerPage.enterEmail("reemexperts@gmail.com");
        // Enter password
        registerPage.enterPassword("riya1234");
        // Enter Confirm Password
        registerPage.enterConfirmPassword("riya1234");
        // Click on "REGISTER" button
        registerPage.clickOnRegisterButton();
